...
import ultimate.ast.CachingBoogieTransformer;
...
import ultimate.type.StructExpanderUtil;
...
public class StructExpander extends CachingBoogieTransformer implements IUnmanagedObserver {
	...
	protected StructExpander(final BoogiePreprocessorBacktranslator translator) {
