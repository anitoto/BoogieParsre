...
/***
 * This interface describes structures that can be visualized by a
 * plugin. Only root elements of graphs need to implement this
...
public interface IVisualizable<E extends IVisualizable<E>> {
	 ...
	 * plugins, so that they only need to consider one graph
	 * structure.
	 * 
