 ...
 */
package ultimate.models.annotation;


import ultimate.models.IElement;
import ultimate.models.annotation.AbstractAnnotations;
...
public class PreprocessorAnnotation extends AbstractAnnotations {
	...
	private static final String pluginName = "Boogie Preprocessor";
	...
	public void annotate(final IElement elem) {
		...
		elem.getPayload().getAnnotations().put(pluginName, this);
	}

	public static PreprocessorAnnotation getAnnotation(final IElement elem) {
		if (elem.hasPayload() && elem.getPayload().hasAnnotation()) {
			return (PreprocessorAnnotation) elem.getPayload().getAnnotations().get(pluginName);
		}
		return null;
	}
