/* RequiresSpecification -- Automatically generated by TreeBuilder (2025-06-30T08:11Z) */
...
public class RequiresSpecification extends Specification {
    ...
    private static final java.util.function.Predicate<BoogieASTNode> VALIDATOR = 
			BoogieASTNode.VALIDATORS.get(RequiresSpecification.class);
    /**
     ...
     */
    public RequiresSpecification(ILocation loc, boolean isFree, Expression formula) {
        super(loc, isFree);
        this.formula = formula;
        assert VALIDATOR == null || VALIDATOR.test(this) : "Invalid RequiresSpecification: " + this;
    }
    ...
    public Specification accept(GeneratedBoogieAstTransformer visitor) {
        ...
        if(formula != newformula){
            return new RequiresSpecification(loc, isFree, newformula);
        }
        return this;
    }
}
