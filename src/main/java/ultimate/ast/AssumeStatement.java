/* AssumeStatement -- Automatically generated by TreeBuilder (2025-06-30T08:11Z) */
...
public class AssumeStatement extends Statement {
    ...
    private static final java.util.function.Predicate<BoogieASTNode> VALIDATOR = 
			BoogieASTNode.VALIDATORS.get(AssumeStatement.class);
    /**
     * The attributes of this assume statement.
     */
    ...
    public AssumeStatement(ILocation loc, Expression formula) {
        ...
        assert VALIDATOR == null || VALIDATOR.test(this) : "Invalid AssumeStatement: " + this;
    }

    /**
     * The constructor taking initial values.
     * @param loc the location of this node
     * @param attributes the attributes of this assume statement.
     * @param formula the formula of this assume statement.
     */
    public AssumeStatement(ILocation loc, NamedAttribute[] attributes, Expression formula) {
        super(loc);
    ...
    /**
     * Gets the attributes of this assume statement.
     * @return the attributes of this assume statement.
     */
    ...
    public Statement accept(GeneratedBoogieAstTransformer visitor) {
        ...
        if(isChanged || formula != newformula){
            return new AssumeStatement(loc, tmpListnewattributes.toArray(new NamedAttribute[0]), newformula);
        }
        return this;
    }
}
