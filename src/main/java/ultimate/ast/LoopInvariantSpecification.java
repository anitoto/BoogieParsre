/* LoopInvariantSpecification -- Automatically generated by TreeBuilder (2025-06-30T08:11Z) */
...
public class LoopInvariantSpecification extends Specification {
    ...
    private static final java.util.function.Predicate<BoogieASTNode> VALIDATOR = 
			BoogieASTNode.VALIDATORS.get(LoopInvariantSpecification.class);
    /**
     ...
     */
    public LoopInvariantSpecification(ILocation loc, boolean isFree, Expression formula) {
        super(loc, isFree);
        this.formula = formula;
        assert VALIDATOR == null || VALIDATOR.test(this) : "Invalid LoopInvariantSpecification: " + this;
    }
    ...
    public Specification accept(GeneratedBoogieAstTransformer visitor) {
        ...
        if(formula != newformula){
            return new LoopInvariantSpecification(loc, isFree, newformula);
        }
        return this;
    }
}
