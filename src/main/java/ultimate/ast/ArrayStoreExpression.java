/* ArrayStoreExpression -- Automatically generated by TreeBuilder (2025-06-30T08:11Z) */
...
public class ArrayStoreExpression extends Expression {
    ...
    private static final java.util.function.Predicate<BoogieASTNode> VALIDATOR = 
			BoogieASTNode.VALIDATORS.get(ArrayStoreExpression.class);
    /**
     ...
     */
    public ArrayStoreExpression(ILocation loc, Expression array, Expression[] indices, Expression value) {
        super(loc);
        this.array = array;
        this.indices = indices;
        this.value = value;
        assert VALIDATOR == null || VALIDATOR.test(this) : "Invalid ArrayStoreExpression: " + this;
    }
     ...
     * @param value the value of this array store expression.
     */
    public ArrayStoreExpression(ILocation loc, IBoogieType type, Expression array, Expression[] indices, Expression value) {
        super(loc, type);
        this.array = array;
        this.indices = indices;
        this.value = value;
    ...
    public Expression accept(GeneratedBoogieAstTransformer visitor) {
        ...
        if(value != null){
            newvalue = (Expression)value.accept(visitor);
        }
        if(isChanged || array != newarray || value != newvalue){
            return new ArrayStoreExpression(loc, type, newarray, tmpListnewindices.toArray(new Expression[0]), newvalue);
        }
        return this;
    }
}
