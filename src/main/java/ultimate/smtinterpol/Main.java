...
import ultimate.smtinterpol.aiger.AIGERFrontEnd;
import ultimate.smtinterpol.dimacs.DIMACSParser;
import ultimate.smtinterpol.option.OptionMap;
import ultimate.smtinterpol.smtlib.SMTLIBParser;
import ultimate.smtinterpol.smtlib2.SMTInterpol;
import ultimate.smtinterpol.smtlib2.SMTLIB2Parser;
	...
	public static void main(String[] param) throws Exception {
		...
		while (paramctr < param.length
			...
			if (param[paramctr].equals("--")) {
				...
				options.set(":verbosity", LogProxy.LOGLEVEL_FINE);
			} else if (param[paramctr].equals("-w")) {
				options.set(":verbosity", LogProxy.LOGLEVEL_WARNING);
			} else if (param[paramctr].equals("-q")) {
				options.set(":verbosity", LogProxy.LOGLEVEL_SEVERE);
				...
				options.set(":verbosity", LogProxy.LOGLEVEL_FINER);
