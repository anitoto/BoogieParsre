 ...
 */
package ultimate.smtinterpol.convert;
...
import ultimate.logic.OccurrenceCounter;
...
import ultimate.smtinterpol.dpll.BooleanVarAtom;
import ultimate.smtinterpol.dpll.ClauseDeletionHook;
...
import ultimate.smtinterpol.dpll.NamedAtom;
import ultimate.smtinterpol.proof.IProofTracker;
import ultimate.smtinterpol.proof.LeafNode;
import ultimate.smtinterpol.proof.NoopProofTracker;
import ultimate.smtinterpol.proof.ProofConstants;
import ultimate.smtinterpol.proof.ProofNode;
import ultimate.smtinterpol.proof.ProofTracker;
import ultimate.smtinterpol.proof.SourceAnnotation;
import ultimate.smtinterpol.theory.cclosure.ArrayTheory;
import ultimate.smtinterpol.theory.cclosure.CCAppTerm;
import ultimate.smtinterpol.theory.cclosure.CCTerm;
import ultimate.smtinterpol.theory.cclosure.CClosure;
import ultimate.smtinterpol.theory.linar.LinArSolve;
import ultimate.smtinterpol.theory.linar.MutableAffinTerm;
...
public class Clausifier {
	...
	public void addFormula(final Term f) {
		if (mEngine.inconsistent()) {
			mLogger.warning("Already inconsistent.");
			return;
		}
