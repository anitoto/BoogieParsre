 ...
 */
package ultimate.smtinterpol.interpolate;
...
import ultimate.smtinterpol.convert.SMTAffineTerm;
...
import ultimate.smtinterpol.theory.linar.InfinitNumber;
...
public class Interpolator extends NonRecursive {
	...
	private void checkInductivity(final HashSet<Term> literals, final Interpolant[] ipls) {
		...
		mLogger.setLoglevel(LogProxy.LOGLEVEL_SEVERE);
