 ...
 */
package ultimate.util.statistics;
...
import ultimate.util.csv.ICsvProvider;
import ultimate.util.csv.ICsvProviderProvider;
import ultimate.util.csv.SimpleCsvProvider;
...
public class Benchmark implements ICsvProviderProvider<Double> {
	...
	public void printResult(final Logger logger) {
