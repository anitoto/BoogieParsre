...
public class CfgSmtToolkit {
	...
	public CfgSmtToolkit(final ModifiableGlobalsTable modifiableGlobalsTable, final ManagedScript managedScript,
			...
			final IcfgEdgeFactory icfgEdgeFactory, final ConcurrencyInformation concurInfo, final SmtSymbols smtSymbols,
			final Logger logger) {
		mManagedScript = managedScript;
		mSymbolTable = symbolTable;
		mModifiableGlobalsTable = modifiableGlobalsTable;
		mOldVarsAssignmentCache = new OldVarsAssignmentCache(mManagedScript, mModifiableGlobalsTable, logger);
