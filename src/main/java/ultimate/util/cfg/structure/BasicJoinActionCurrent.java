...
public class BasicJoinActionCurrent extends AbstractBasicAction implements IJoinActionThreadCurrent {
	...
	public BasicJoinActionCurrent(final String preceedingProcedure, final String succeedingProcedure,
			final UnmodifiableTransFormula transFormula, final JoinSmtArguments joinSmtArguments) {
