...
public final class ActionUtils {
	 ...
	 *
	 * @see {@link TransFormulaBuilder#constructCopy(ManagedScript, ultimate.util.cfg.transitions.TransFormula, java.util.Collection, java.util.Collection, java.util.Map)
	 */
	public static IAction constructCopy(final ManagedScript script, final IAction action, final Logger logger) {
		if (action == null) {
			return null;
		}
		final IAction rtr;
		if (action instanceof IInternalAction) {
			...
			final UnmodifiableTransFormula newTf = TransFormulaBuilder.constructCopy(script, oldTf,
					Collections.emptySet(), Collections.emptySet(), Collections.emptyMap(), logger);
