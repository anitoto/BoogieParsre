 ...
 */
package ultimate.util.hoaretriple;

import java.util.Collection;
import java.util.concurrent.TimeUnit;

import ultimate.util.hoaretriple.IHoareTripleChecker.HoareTripleCheckerStatisticsDefinitions;
import ultimate.util.InCaReCounter;
import ultimate.util.statistics.Benchmark;
import ultimate.util.statistics.IStatisticsDataProvider;
import ultimate.util.statistics.IStatisticsType;
