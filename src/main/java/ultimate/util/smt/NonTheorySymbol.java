...
public abstract class NonTheorySymbol<SYMBOL> {
	...
	public static Set<NonTheorySymbol<?>> extractNonTheorySymbols(Term term, final Logger logger) {
		return (new NonTheorySymbolFinder()).findNonTheorySymbols(term, logger);
	}
