...
import ultimate.util.smt.arrays.MultiDimensionalSelectOverStore;
import ultimate.util.smt.managedscript.ManagedScript;

/**
 * Provides auxiliary methods for our partitial quantifier elimination for
 * arrays.
 * 
...
public class ArrayQuantifierEliminationUtils {
	...
	public static Term transformMultiDimensionalSelectOverNestedStoreToIte(
		...
		Term ite = mdsos.constructNotEqualsReplacement(mgdScript.getScript(), logger);
