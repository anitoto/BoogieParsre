...
public final class MaximizeFinalStates extends BaseBlockEncoder<IcfgLocation> {
	...
	public MaximizeFinalStates(final Consumer<IcfgLocation> funMarkAsAccepting, final Predicate<IcfgLocation> funIsAccepting, final BlockEncodingBacktranslator backtranslator, final Logger logger) {
	...
	protected BasicIcfg<IcfgLocation> createResult(final BasicIcfg<IcfgLocation> icfg) {
		...
		logger.info(mNewAcceptingStates + " new accepting states");
		return icfg;
	}
