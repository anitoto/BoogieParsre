 ...
 * statements which are executed one after the
...
public class StatementSequence extends CodeBlock implements IIcfgInternalTransition<IcfgLocation> {
	...
	/**
	 * mOrigin stores the origin of this InternalEdge, which could be either be the
	 * ensures specification, the requires
	...
	/**
	 * Add a new {@link Statement} to this statement sequence. Only internal
	 * statements are allowed, i.e., no Call,
	 * Return, Summary.
	 */
