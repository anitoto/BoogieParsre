...
import ultimate.util.statistics.GraphSizeCsvProvider;
import ultimate.util.statistics.StatisticsResult;
...
public class IcfgSizeBenchmark {
	...
	public StatisticsResult<Integer> getBenchmarkResult(final String pluginId, final String message) {
		return new StatisticsResult<Integer>(pluginId, message, mCsvProvider);
	}
}
