 ...
 * get-interpolants command. Supports iZ3 and
 * Princess.
 *
...
public class ScriptorWithGetInterpolants extends Scriptor {
	...
	public ScriptorWithGetInterpolants(final String command, final ExternalInterpolator externalInterpolator,
			final String name, final Logger logger, final Storage storage) throws IOException {
		super(command, name, logger, storage);
