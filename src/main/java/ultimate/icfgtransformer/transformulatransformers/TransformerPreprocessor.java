...
/**
 * A preprocessor performs some modifications to the input formulae for stem and
 * loop.
 * 
 * This is the base class for processors that use a TermTransformer on the
 * transition formula. Creates a new
...
public abstract class TransformerPreprocessor extends TransitionPreprocessor {
	...
	/**
	 * Create a TermTransformer instance that will be applied to the stem and the
	 * loop transition formula.
	 */
